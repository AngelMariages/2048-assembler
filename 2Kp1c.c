 ...
 * fila 18, columna 26 cridant la subrutina showNumberP1_C.
 ...
 * primera fila passa a ser la primera columna, la segona fila passa a ser
 ...
 * i tornar a desplaçar els nombres cap a l'esquerra (shiftNumbersRP1_C)
 ...
 * Mentre (state=='1') fer
 *   Llegir una tecla (cridar la funció readKeyP1_C). Segons la tecla
